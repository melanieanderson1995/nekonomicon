...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post cats_url, params: { cat: { age: @cat.age, breed_id: @cat.breed_id, gender: @cat.gender, image_url: @cat.image_url, name: @cat.name } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { age: @cat.age, breed_id: @cat.breed_id, gender: @cat.gender, image_url: @cat.image_url, name: @cat.name } }
