...
class BreedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create breed" do
    assert_difference('Breed.count') do
      post breeds_url, params: { breed: { description: @breed.description, image_url: @breed.image_url, name: @breed.name, rare: @breed.rare } }
    end
  ...
  test "should update breed" do
    patch breed_url(@breed), params: { breed: { description: @breed.description, image_url: @breed.image_url, name: @breed.name, rare: @breed.rare } }
